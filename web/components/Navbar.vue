  ...
  <nav class="bg-white shadow dark:bg-gray-800">
    <div class="container px-6 py-4 mx-auto">
      <div class="md:flex md:items-center md:justify-between">
        ...
        >
          ...
          <div class="flex items-center mt-4 md:mt-0">
            ...
            >
              ...
              >
                <img
                  :src="getAvatar(this.$auth.user.id, this.$auth.user.avatar)"
                ...
                >
                  ...
                  <a
                    @click="logOut()"
                    class="flex items-center cursor-pointer p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
                  >
                    <svg
                      class="w-5 h-5 mx-1"
                      viewBox="0 0 24 24"
        ...
        <div
          v-else
          class="flex-1 hidden md:flex md:items-center md:justify-between"
        >
          <div class="flex flex-col -mx-4 md:flex-row md:items-center md:mx-8">
            <a
              href="/invite"
  ...
  methods: {
    ...
    logOut() {
      this.$auth
        ...
        .catch((e) => {
          this.$toast.error(`Couldn't log you out`, {
            position: 'bottom-right',
            duration: 5000,
            closeOnSwipe: true,
          })
    ...
    getAvatar(userid: string, icon: string) {
      if (!icon || icon == null || icon == undefined) {
        return '/default-guild-icon.png'
      } else {
        return `https://cdn.discordapp.com/avatars/${userid}/${icon}.png`
      }
    },
    toggleDropdown() {
